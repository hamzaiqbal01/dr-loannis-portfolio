    ...
    <div className={`flex items-center gap-3 ${className}`}>
      {socialLinks.map(({ label, href, icon }) => (
        <a
          ...
          aria-label={label}
          className={`inline-flex items-center justify-center w-10 h-10 rounded-full border border-current/15 transition-colors duration-200 no-underline ${iconClassName}`}
        >
